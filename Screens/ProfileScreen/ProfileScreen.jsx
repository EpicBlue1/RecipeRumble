...
const ProfileScreen = () => {
  return (
    <View>
        <ImageBackground style={ProfileStyles.image} source={require("../../assets/Backgrounds/Orange_Background.png")}>
            <View style={ProfileStyles.InnerContainer}>
                <Image style={ProfileStyles.Profile} source={require("../../assets/ProfileTemp.jpg")}/>

                <View>
                    <Text style={ [Global.HeadingTwo, ProfileStyles.white]}>Reinhardt van Aarde</Text>
                    <Text style={ [Global.HeadingThree, ProfileStyles.white]}>reinardt.vanAarde@gmail.com</Text>
                </View>
            </View>
        </ImageBackground>
